...
export class CM_ButtonDesign extends Component {
    ...
    render() {
        ...
        return (
            ...
            <TouchableOpacity onPress={() => this.props.onPress_BuutonView()} style={{ height: height / 100 * 7, backgroundColor:this.props.CMB_BuutonColourcode, marginLeft: width / 100 * 5, marginRight: width / 100 * 5, borderRadius: height / 100 * 3.5, justifyContent: 'center', alignItems: 'center' }}>
