...
export class Card_Draftsheet extends Component {
            ...
            <TouchableOpacity onPress={() => this.props.CardList_Method()}
                ...
                <View style={{ flex: 1, justifyContent: "center"}}>
                    ...
                    <View style={{ flex: 0.2, justifyContent: 'center', flexDirection: "row" }}>
                        ...
                        {
                            this.props.Card_ActiveStatus == true ?
                                <TouchableOpacity onPress={() => this.props.CardList_AMORE()} style={{ flex: 0.5, justifyContent: 'center', backgroundColor: LG_BG_THEME.APPTHEME_Green, borderBottomLeftRadius: width / 100 * 3, alignItems: "center" }}>

                                    <Text numberOfLines={1} style={styles.container_ThemeText}>{"DraftEdit"}</Text>
                            ...
                            {
                            this.props.Card_ActiveStatus == true ?
                                <TouchableOpacity onPress={() => this.props.Delete_CardList_AMORE()} style={{ flex: 0.5, justifyContent: 'center', backgroundColor: this.props.Card_BG, borderBottomLeftRadius: width / 100 * 3, alignItems: "center" }}>
