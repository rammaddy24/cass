...
class Edit_Timesheet extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            S2_Overall_QuantityId: [],
            S2_Selected_QuantityId: [],
            S2_UnSelected_QuantityId: [],
            S2_QtyArraylist_Response: [],
    ...
    componentDidMount() {
        ...
        this.setState({
            ...
            S1_DateVisible: Moment(TSEdit_Response.job_date).format('DD-MM-YYYY'),
    ...
    async Qty_ListMethod(Route_Data, CassUserID, CassRoleID) {
        ...
        try {
            ...
            //console.error(Sel_QtyInfo_Arraylist)
            this.setState({
                S2_UnSelected_QuantityId: this.state.S2_Overall_QuantityId.filter(n => !this.state.S2_Selected_QuantityId.includes(n))
            })

            this.setState({
                S2_UnSelected_QuantityId: Array.from(new Set(Array.from(new Set(this.state.S2_UnSelected_QuantityId)))),
            })
            ...
            this.setState({
                S2_Quatitylist_Response: Array.from(new Set(Array.from(new Set(Sel_QtyInfo_Arraylist)).concat(Array.from(new Set(QtyInfo_Arraylist))))),
            })
            ...
            if (this.state.Add_TimesheetScreenIndex == 4) {
                ...
                for (let i = 0; i < this.state.S1_Engineer_DataArray.length; i++) {
                    if (this.state.Engineer_Edited == true) {
                        this.state.S4_CostInfo.pop({
                            "username": this.state.S1_Engineer_DataArray[i].full_name,
                            "user_percentage": (100 / (this.state.S1_Engineer_ArrayId.length)).toFixed(2),
                            "user_cost": ((this.state.S2_Qty_Amount / this.state.S1_Engineer_ALength)).toFixed(2),
                        })
                        this.setState({ S4_CostPercentage_AE: [], S4_UserAmount_AE: [] })
                    } else {
                        this.state.S4_CostInfo.pop({
                            "username": this.state.S1_Engineer_DataArray[i].full_name,
                            "user_percentage": this.state.S4_CostPercentage_BE[i] == undefined ? "0.0" : this.state.S4_CostPercentage_BE[i],
                            "user_cost": this.state.S4_UserAmount_BE[i] == undefined ? "0.00" : this.state.S4_UserAmount_BE[i],
                        })
                    }
                }
    ...
    S1C_ToggleMethod(Route_Data, RouteName) {
        ...
        if (RouteName == "Department") {
            ...
            this.setState({ Engineer_Edited: true })
        }
    ...
    async Timesheet_Method(Route_Data) {
        ...
        if (Route_Data == "Finish") {
            ...
            if (this.state.Add_TimesheetScreenIndex == 1) {
                if (this.state.S1_Dept_ID == "") {
                ...
                else if (this.state.S1_Engineer_ArrayId.length == 0) {
                    Snackbar.show({
                        title: 'Select Engineer..!',
                        duration: Snackbar.LENGTH_SHORT,
                    });
                    ...
                    this.setState({
                        ...
                        S1_Engineer_ALength: this.state.S1_Engineer_ArrayId.length
                    })
                ...
                if (Route_Data == "Prev") {
                    ...
                    for (let i = 0; i < this.state.S1_Engineer_DataArray.length; i++) {
                        if (this.state.Engineer_Edited == true) {
                            ...
                            this.state.S4_CostPercentage_AE.push(this.state.S4_CostInfo[i].user_percentage)
                            this.state.S4_UserAmount_AE.push(this.state.S4_CostInfo[i].user_cost)
                        } else {
                            this.state.S4_CostInfo.push({
                                "username": this.state.S1_Engineer_DataArray[i].full_name,
                                "user_percentage": this.state.S4_CostPercentage_BE[i] == undefined ? "0.0" : this.state.S4_CostPercentage_BE[i],
                    ...
                    if (this.state.Engineer_Edited == true) {
                        for (let i = 0; i < this.state.S4_CostPercentage_AE.length; i++) {
                            C4_Cost.push({
                                ...
                                "C4_Amount": ((this.state.S2_Qty_Amount * this.state.S4_CostPercentage_AE[i]) / 100)
                            })
                        }
                    } else {
                        for (let i = 0; i < this.state.S4_CostPercentage_BE.length; i++) {
                            C4_Cost.push({
                                ...
                                "C4_Amount": ((this.state.S2_Qty_Amount * this.state.S4_CostPercentage_BE[i]) / 100)
                            })
                        }
                    }
                ...
                if (Route_Data == "Prev") {
                    ...
                    if (this.state.Engineer_Edited == true) {
                        for (let i = 0; i < this.state.S4_CostPercentage_AE.length; i++) {
                            C4_Cost += parseFloat(this.state.S4_CostPercentage_AE[i])
                        }
                    } else {
                        for (let i = 0; i < this.state.S4_CostPercentage_BE.length; i++) {
                            C4_Cost += parseFloat(this.state.S4_CostPercentage_BE[i])
                        }
                    }
                    ...
                    if (this.state.Engineer_Edited == true) {
                        ...
                        for (let i = 0; i < this.state.S4_CostPercentage_AE.length; i++) {
                            this.state.S4_UserAmount_AE[i] = ((this.state.S2_Qty_Amount * this.state.S4_CostPercentage_AE[i]) / 100)
                        }
                    } else {
                        for (let i = 0; i < this.state.S4_CostPercentage_BE.length; i++) {
                            this.state.S4_UserAmount_BE[i] = ((this.state.S2_Qty_Amount * this.state.S4_CostPercentage_BE[i]) / 100)
                        }
                    }
    ...
    Signature_Method(Route_Data, Sign_OP) {
        if (Route_Data == "Save") {
            if(this.refs["sign"]&& !this.state.Signature_Image ){
            this.refs["sign"].saveImage();
            this.setState({SignatureSaved:true});
            }
          //  this.setState({Signature_Image:true});
           // console.log("##signOP",Sign_OP);
           // const fileTye= 'image/png;base64,';
            //this.setState({Signature_Image:`${fileTye}${Sign_OP.encoded}`});
                                                    ...
                                                    <View style={{ flex: 1, justifyContent: "center" }}>
                                                        ...
                                                        {/* <View style={{ height: height / 100 * 6, justifyContent: "center", flexDirection: 'row' }}>
                                                            ...
                                                            <View style={{ flex: 0.45, justifyContent: "center" }}>
                                                                <Text style={styles.S1C_ButtonText}>{}</Text>
                                                            </View>
                                                                            ...
                                                                            <View style={{ height: height / 100 * 7, justifyContent: "center", flexDirection: "row", marginLeft: width / 100 * 2, marginRight: width / 100 * 2 }}>
                                                                                <View style={{ flex: 1, justifyContent: 'center', backgroundColor: LG_BG_THEME.WHITE_THEME }}>
                                                                                    ...
                                                                                    <TextInput
                                                                                        ...
                                                                                        onChangeText={text => {
                                                                                            let { S4_CostPercentage_BE, S4_CostPercentage_AE, Engineer_Edited } = this.state;
                                                                                            if (text < 101) {
                                                                                                if (Engineer_Edited == true) {
                                                                                                    S4_CostPercentage_AE[index] = text;
                                                                                                    this.setState({ S4_CostPercentage_AE });
                                                                                                } else {
                                                                                                    S4_CostPercentage_BE[index] = text;
                                                                                                    this.setState({ S4_CostPercentage_BE });
                                                                                                }
                                                                                ...
                                                                                <View style={{ flex: 1, justifyContent: 'center', backgroundColor: LG_BG_THEME.APPTHEME_1 }}>
                                                                                    ...
                                                                                    {
                                                                                        this.state.Engineer_Edited == true ?
                                                                                            <Text style={styles.S2_Qty_WMedium}>{"£ " + (isNaN((this.state.S2_Qty_Amount * this.state.S4_CostPercentage_AE[index] / 100)) == true ? "0.00" : ((this.state.S2_Qty_Amount * this.state.S4_CostPercentage_AE[index] / 100).toFixed(2)))}</Text>

                                                                                            :
                                                                                            <Text style={styles.S2_Qty_WMedium}>{"£ " + (isNaN((this.state.S2_Qty_Amount * this.state.S4_CostPercentage_BE[index]) / 100) == true ? "0.00" : ((this.state.S2_Qty_Amount * this.state.S4_CostPercentage_BE[index]) / 100).toFixed(2))}</Text>
                                                                            ...
                                                                            <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
                                                                                ...
                                                                                <View style={{ flex: 1, justifyContent: "center" }}>
                                                                                    ...
                                                                                    <View style={{ flex: 1, }}>
                                                                                        ...
                                                                                        {this.state.S4_CostInfo_Prev.map((item, index) => (

                                                                                            <View style={{ flex: 1, justifyContent: "center", }}>

                                                                                                <View style={{ height: height / 100 * 6, justifyContent: "center", alignItems: "flex-start", opacity: 0.6, elevation: Platform.OS == "android" ? width / 100 * 1 : width / 100 * 0.1, shadowOffset: { width: 2, height: 2 }, shadowOpacity: 0.2, shadowColor: LG_BG_THEME.APPTHEME_2, }}>
                                                                                                    <Text style={styles.S2_Qty_BMedium}>{this.state.S1_Engineer_DataArray[index] ? this.state.S1_Engineer_DataArray[index].full_name:''}</Text>
                                                                                                </View>


                                                                                                <View style={{ height: height / 100 * 6, justifyContent: "center", flexDirection: "row", marginLeft: width / 100 * 2, marginRight: width / 100 * 2 }}>
                                                                                                    <View style={{ flex: 1, justifyContent: 'center', backgroundColor: LG_BG_THEME.WHITE_THEME }}>
                                                                                                        <Text style={styles.S2_Qty_BMedium}>{"% " + (item.C4_Cost)}</Text>
                                                                                                    </View>

                                                                                                    <View style={{ flex: 1, justifyContent: 'center', backgroundColor: LG_BG_THEME.APPTHEME_1 }}>
                                                                                                        <Text style={styles.S2_Qty_WMedium}>{"£ " + (item.C4_Amount)}</Text>
                                                                                                    </View>
                                                                                                </View>
                            ...
                            <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', borderRadius: width / 100 * 2, flexDirection: "row" }}>
                                ...
                                <View style={{ flex: 0.8, justifyContent: 'center' }}>
                                    ...
                                    <View style={{ height: width / 100 * 12, justifyContent: 'center', alignSelf: 'center', backgroundColor: LG_BG_THEME.APPTHEME_1, borderTopLeftRadius: width / 100 * 2, borderTopRightRadius: width / 100 * 2, flexDirection: 'row' }}>
                                        <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                                            <Text numberOfLines={1} style={{ fontSize: fontSize.Medium, fontFamily: fontFamily.Poppins_Bold, letterSpacing: width / 100 * 0.1, color: color.Font_Whitecolor, textAlign: "center" }}>{this.state.S1_DateVisible}</Text>
                                        </View>
